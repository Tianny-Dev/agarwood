...
<body>
    ...
    <div class="section">
        <h2>Investor / User Information</h2>
    ...
    <div class="section">
        ...
        <table class="info-table">
            <tr><td>ID Type</td><td>{{ $investor->id_type }}</td></tr>
            @if(isset($investor->is_paid))
            <tr><td>Payment Status</td><td>{{ $investor->is_paid ? 'Paid' : 'Unpaid' }}</td></tr>
            @endif
        </table>
    </div>
